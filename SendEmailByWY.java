...
getPasswordAuthentication(){
 ...
 return new PasswordAuthentication("xiaohai_sweet@163.com"
         , "NIVOBFARHJBEKEMH");
...
//        2、创建邮件对象
 ...
 message.setFrom( new InternetAddress("xiaohai_sweet@163.com") );
 ...
 message.setRecipient(RecipientType.CC , new InternetAddress("xiaohai_sweet@163.com"));
